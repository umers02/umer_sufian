...
export default function Landing() {
  ...
  return (
    ...
    >
      ...
      {/* Hero Section */}
      <section className="relative bg-white w-full py-8 lg:py-0">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center min-h-[500px] lg:min-h-[628px]">
            {/* Left Image */}
            <div className="relative order-2 lg:order-1">
              <img
                src="/landing-page-main.jpg"
                alt="Tea collection with various loose teas in spoons"
                className="w-full h-64 sm:h-80 md:h-96 lg:h-[500px] object-cover rounded-lg lg:rounded-none"
              />
            </div>
            ...
            <div className="space-y-6 order-1 lg:order-2 text-center lg:text-left">
              <h1
                className="text-2xl sm:text-3xl lg:text-4xl font-medium text-gray-900 leading-tight"
              ...
              <div
                className="space-y-4 text-gray-600 text-sm sm:text-base"
                style={{ fontFamily: "Montserrat, sans-serif" }}
              >
                <p>
              ...
              <Link to="/collection">
                <Button className="bg-black hover:bg-gray-900 text-white px-8 sm:px-12 lg:px-16 py-3 rounded-none text-sm font-light">
                  BROWSE TEAS
                </Button>
              </Link>
            </div>
      ...
      <section className="py-16" style={{ backgroundColor: "#F4F4F4" }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex items-center justify-center gap-2">
              ...
              >
                ...
                <g mask="url(#mask0_171_157)">
                  <path
                    d="M4 21V19H20V21H4ZM8 17C6.9 17 5.95833 16.6083 5.175 15.825C4.39167 15.0417 4 14.1 4 13V3H20C20.55 3 21.0208 3.19583 21.4125 3.5875C21.8042 3.97917 22 4.45 22 5V8C22 8.55 21.8042 9.02083 21.4125 9.4125C21.0208 9.80417 20.55 10 20 10H18V13C18 14.1 17.6083 15.0417 16.825 15.825C16.0417 16.6083 15.1 17 14 17H8ZM8 15H14C14.55 15 15.0208 14.8042 15.4125 14.4125C15.8042 14.0208 16 13.55 16 13V5H6V13C6 13.55 6.19583 14.0208 6.5875 14.4125C6.97917 14.8042 7.45 15 8 15ZM18 8H20V5H18V8Z"
                    fill="#282828"
                  />
                </g>
              </svg>
          ...
          <div className="text-center mt-12">
            <Button
              variant="outline"
              className="px-16 py-3 rounded-none bg-transparent border-gray-800"
            >
              LEARN MORE
            </Button>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2
            className="text-4xl font-medium text-center text-gray-900 mb-16"
            style={{ fontFamily: "Prosto One, cursive" }}
          >
            Our Collections
          </h2>
              ...
              {categories.slice(0, 8).map((category, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    />
                    <h3
                      className="text-gray-900 text-lg font-light p-6 text-center"
                      style={{ fontFamily: "Montserrat, sans-serif" }}
                    >
