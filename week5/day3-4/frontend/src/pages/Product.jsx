...
import ReviewForm from "../components/reviews/SimpleReviewForm";
import ReviewList from "../components/reviews/SimpleReviewList";
    ...
    const fetchProductData = async () => {
      try {
        ...
        if (!isValidObjectId(id)) {
          setError(
            "Invalid product ID. Please select a product from the Collection page."
          );
          setLoading(false);
          return;
        }
        ...
        if (error.response?.status === 404) {
          setError(
            "Product not found. Please select a product from the Collection page."
          );
  ...
  return (
    ...
    >
              ...
              <div className="mb-6">
                ...
                <div className="grid grid-cols-3 sm:grid-cols-6 gap-3">
                  {productData.variants.map((variant) => (
                    ...
                    >
                      {variant.size === "50g" ||
                      variant.name?.toLowerCase().includes("50g") ? (
                        <svg
                          width="84"
                          height="101"
                          viewBox="0 0 84 101"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 border-t">
        <h2 className="text-2xl font-bold mb-8" style={{ fontFamily: "Prosto One, cursive" }}>
          Customer Reviews
        </h2>
