...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const redirectUrl = auth.getRoleBasedRedirect()
  ...
  return (
    <div className="min-h-screen ott-bg flex items-center justify-center p-4">
      {/* Background Pattern */}
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400">Welcome back to your streaming experience</p>
        </div>
        ...
        <div className="ott-card rounded-2xl p-8">
          ...
          <div className="mt-6">
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              <button className="w-full inline-flex justify-center py-2 px-4 border border-gray-600 rounded-lg bg-gray-800 text-sm font-medium text-gray-300 hover:bg-gray-700 transition-colors">
