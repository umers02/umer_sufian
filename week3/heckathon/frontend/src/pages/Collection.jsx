...
export default function Collection() {
  ...
  return (
    ...
    >
      ...
      {/* Hero Image */}
      <div
        className="relative h-48 sm:h-56 md:h-64 lg:h-72 w-full bg-cover bg-center"
        style={{ backgroundImage: "url(/collection-hero-section.jpg)" }}
      >
      ...
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6 lg:py-8">
        <div className="flex flex-col lg:flex-row gap-4 lg:gap-8 w-full">
          ...
          <div className="flex-1 min-w-0 w-full">
            ...
            <div className="flex flex-col sm:flex-row justify-between lg:justify-end items-start sm:items-center gap-4 mb-4 lg:mb-6">
              <Button
                variant="outline"
              ...
              <Select value={sortBy} onValueChange={handleSortChange}>
                <SelectTrigger
                  className="w-full sm:w-48 border-none text-black"
                  style={{ fontFamily: "Montserrat, sans-serif" }}
                >
            ...
            {showMobileFilters && (
              <div className="lg:hidden mb-4 lg:mb-6 p-3 sm:p-4 bg-gray-50 rounded-lg max-h-80 sm:max-h-96 overflow-y-auto">
                <div className="space-y-4">
                  {/* COLLECTIONS Filter */}
                  <div className="border-b pb-4">
                    <button
            ...
            {selectedCategories.length > 0 && (
              <div className="mb-3 lg:mb-4 p-2 sm:p-3 bg-gray-50 rounded-lg">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 gap-3 sm:gap-4 lg:gap-6">
                  {products.map((product) => (
                    <div key={product._id} className="w-full min-w-0">
                      ...
                      >
                        <div className="bg-gray-100 aspect-square mb-4 w-full overflow-hidden">
                          <img
                        ...
                        <div className="text-center mb-2 px-1 sm:px-2">
                          <h3
                            className="text-gray-900 font-medium text-xs sm:text-sm lg:text-base break-words"
                            style={{ fontFamily: "Montserrat, sans-serif" }}
                          >
                            {product.name}
                          </h3>
